...
<div style="line-height: 10px;">
	...
	管理员：${sessionScope.admin.adminName }</span>
	<a target="_top" href="<c:url value='/adminjsps/login.jsp'/>">退出</a>
	</c:if>
	<c:if test="${empty sessionScope.admin }">
	<span>管理员： <a href="<c:url value='/adminjsps/login.jsp'/>" target="_parent" target="_top">登录</a></span>
	</c:if>
	<span style="padding-left:50px;">
		...
		<a href="<c:url value='/admin/AdminAnnouncementServlet?method=findAnnouncement'/>">公告管理</a>
		<a href="<c:url value='/index.jsp'/>" target="_top">返回前台</a>
	</span>
</div>
  </body>
</html>
